@if (session()->has('success') || session()->has('error'))
    ...
    <div id="custom-toast" class="fixed top-5 right-5 z-[9999] flex items-center gap-3 rounded-lg border {{ $borderColor }} {{ $bgColor }} px-4 py-3 shadow-2xl transition-all duration-500 transform translate-y-0 opacity-100 min-w-[300px]">
