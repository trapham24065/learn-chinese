...
// Toast Mixin: góc trên phải, tự biến mất sau 3.5s, có thanh thời gian chạy
...
// Helper Dialog toàn cục (Center Modal)
window.dialog = {
    confirm: async ({
    ...
    // Modal mời đăng nhập khi bấm ⭐ Lưu từ vựng vào Sổ tay
    authRequired: ({
