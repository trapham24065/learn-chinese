...
class MediaAssetResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Kho Tư liệu Đồ họa';

    protected static ?string $modelLabel = 'tư liệu đồ họa';

    protected static ?string $pluralModelLabel = 'kho tư liệu đồ họa';
