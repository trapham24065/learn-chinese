...
<div class="space-y-8">
    ...
    <div class="space-y-6">
        ...
        'questions' => [
            ...
            [
                'question' => 'Đại từ nhân xưng ngôi thứ nhất số ít trong tiếng Trung là gì?',
                'pinyin' => 'wǒ',
                'options' => ['我', '你', '他', '她'],
                'correct_answer' => '我',
                'explanation' => 'Đại từ "我" (wǒ) có nghĩa là "tôi" (ngôi thứ nhất số ít). "你" là bạn, "他/她" là anh ấy/cô ấy.',
                'difficulty' => 'starter',
                'skill_type' => 'vocabulary',
            ],
        ],
...
<div class="space-y-8">
    ...
    <div class="space-y-6">
        ...
        'questions' => [
            ...
            [
                'question' => 'Từ "再见" (tạm biệt) được phát âm như thế nào?',
                'pinyin' => 'zàijiàn',
                'options' => ['zàijiàn', 'zàijian', 'zāijiàn', 'zàijiān'],
                'correct_answer' => 'zàijiàn',
                'explanation' => 'Từ "再见" gồm hai thanh 4 đi liền nhau, phát âm dứt khoát và mạnh: zàijiàn.',
                'difficulty' => 'starter',
                'skill_type' => 'listening',
            ],
            [
                'question' => 'Khi nói "Không cần cảm ơn", ta dùng mẫu câu nào?',
                'pinyin' => 'bú yòng xiè',
                'options' => ['不用谢。', '不客气。', '对不起。', '没关系。'],
                'correct_answer' => '不用谢。',
                'explanation' => '"不用谢" (bú yòng xiè) có nghĩa là không cần cảm ơn, dùng tương tự như "不客气".',
                'difficulty' => 'starter',
                'skill_type' => 'vocabulary',
            ],
        ],
...
<div class="space-y-8">
    ...
    <div class="space-y-6">
        ...
        'questions' => [
            ...
            [
                'question' => 'Điền từ thích hợp vào chỗ trống: 你是___国人？',
                'pinyin' => 'nǐ shì nǎ guó rén?',
                'options' => ['哪', '那', '谁', '什么'],
                'correct_answer' => '哪',
                'explanation' => 'Để hỏi quốc tịch, ta dùng đại từ nghi vấn "哪" (nǎ - nào): 哪国人 (người nước nào).',
                'difficulty' => 'starter',
                'skill_type' => 'grammar',
            ],
            [
                'question' => 'Từ "名字" (tên) phát âm đúng chuẩn là gì?',
                'pinyin' => 'míngzi',
                'options' => ['míngzi (thanh 2 + thanh nhẹ)', 'míngzì (thanh 2 + thanh 4)', 'mìngzi (thanh 4 + thanh nhẹ)', 'míngzī (thanh 2 + thanh 1)'],
                'correct_answer' => 'míngzi (thanh 2 + thanh nhẹ)',
                'explanation' => 'Chữ "字" khi đứng độc lập mang thanh 4 (zì), nhưng trong từ "名字" thì đọc thành thanh nhẹ (zi).',
                'difficulty' => 'starter',
                'skill_type' => 'listening',
            ],
        ],
...
<div class="space-y-8">
    ...
    <div class="space-y-6">
        ...
        'questions' => [
            ...
            [
                'question' => 'Đại từ "她" (cô ấy) và "他" (anh ấy) khác nhau ở điểm nào trong chữ Hán?',
                'pinyin' => 'tā',
                'options' => ['"她" có bộ Nữ (女) chỉ nữ giới, "他" có bộ Nhân đứng (亻) chỉ nam giới chung', 'Phát âm khác nhau', 'Không khác nhau gì', 'Một từ dùng cho người, một từ dùng cho vật'],
                'correct_answer' => '"她" có bộ Nữ (女) chỉ nữ giới, "他" có bộ Nhân đứng (亻) chỉ nam giới chung',
                'explanation' => 'Hai từ này đồng âm (tā) nhưng khác chữ viết: "她" chỉ phái nữ, "他" chỉ phái nam.',
                'difficulty' => 'starter',
                'skill_type' => 'vocabulary',
            ],
            [
                'question' => 'Chọn cách nói đúng cho cụm "bạn học của tôi":',
                'pinyin' => 'wǒ de tóngxué',
                'options' => ['我的同学', '同学的我', '我同学的', '同学我'],
                'correct_answer' => '我的同学',
                'explanation' => 'Cấu trúc sở hữu trong tiếng Trung là: Người sở hữu + 的 + Vật/Người được sở hữu. Vì vậy "bạn học của tôi" là 我的同学.',
                'difficulty' => 'starter',
                'skill_type' => 'grammar',
            ],
        ],
...
<div class="space-y-8">
    ...
    <div class="space-y-6">
        ...
        'questions' => [
            ...
            [
                'question' => 'Từ "岁" (suì) được dùng để làm gì?',
                'pinyin' => 'suì',
                'options' => ['Chỉ tuổi tác', 'Chỉ tiền bạc', 'Chỉ ngày tháng', 'Chỉ thời gian'],
                'correct_answer' => 'Chỉ tuổi tác',
                'explanation' => '"岁" (Tuế) dùng làm lượng từ chỉ tuổi tác. Ví dụ: 二十岁 (20 tuổi).',
                'difficulty' => 'starter',
                'skill_type' => 'vocabulary',
            ],
            [
                'question' => 'Để hỏi tuổi của người lớn hoặc người trưởng thành, ta dùng câu nào?',
                'pinyin' => 'nǐ duō dà le?',
                'options' => ['你多大了？', '你几岁？', '你什么岁？', '你多岁了？'],
                'correct_answer' => '你多大了？',
                'explanation' => '"多大了" dùng để hỏi tuổi người lớn/trưởng thành. "几岁" thường dùng hỏi trẻ em dưới 10 tuổi.',
                'difficulty' => 'starter',
                'skill_type' => 'grammar',
            ],
        ],
...
<div class="space-y-8">
    ...
    <div class="space-y-6">
        ...
        'questions' => [
            ...
            [
                'question' => 'Động từ "会" (huì) trong câu "我会说汉语" biểu thị ý nghĩa gì?',
                'pinyin' => 'huì',
                'options' => ['Biết làm gì đó thông qua quá trình học tập, rèn luyện', 'Có khả năng làm gì đó do bản năng', 'Đang làm gì đó', 'Sẽ làm gì đó'],
                'correct_answer' => 'Biết làm gì đó thông qua quá trình học tập, rèn luyện',
                'explanation' => '"会" (biết) đứng trước động từ thể hiện kỹ năng có được nhờ học hỏi, ví dụ biết nói tiếng Hán, biết nấu ăn.',
                'difficulty' => 'starter',
                'skill_type' => 'grammar',
            ],
            [
                'question' => 'Câu "Mẹ tôi biết nấu món ăn Trung Quốc" dịch sang tiếng Trung là gì?',
                'pinyin' => 'Wǒ māma huì zuò Zhōngguó cài',
                'options' => ['我妈妈会做中国菜。', '我妈妈说做中国菜。', '我妈妈能做中国菜。', '我妈妈想做中国菜。'],
                'correct_answer' => '我妈妈会做中国菜。',
                'explanation' => '"做菜" là nấu ăn, "会做中国菜" là biết nấu món Trung Quốc.',
                'difficulty' => 'starter',
                'skill_type' => 'vocabulary',
            ],
            [
                'question' => 'Điền từ thích hợp: 中国菜很___(ngon).',
                'pinyin' => 'Zhōngguó cài hěn hǎochī',
                'options' => ['好吃', '好看', '好听', '好喝'],
                'correct_answer' => '好吃',
                'explanation' => '"好吃" (hǎochī) nghĩa là ngon (dùng cho đồ ăn). "好看" là đẹp, "好听" là hay (âm thanh), "好喝" là ngon (đồ uống).',
                'difficulty' => 'starter',
                'skill_type' => 'vocabulary',
            ],
        ],
...
<div class="space-y-8">
    ...
    <div class="space-y-6">
        ...
        'questions' => [
            ...
            [
                'question' => 'Trật tự thời gian trong tiếng Trung được sắp xếp như thế nào?',
                'pinyin' => 'shíjiān shùnxù',
                'options' => ['Từ đơn vị lớn đến đơn vị nhỏ (Năm -> Tháng -> Ngày)', 'Từ đơn vị nhỏ đến đơn vị lớn (Ngày -> Tháng -> Năm)', 'Tháng -> Ngày -> Năm', 'Ngày -> Năm -> Tháng'],
                'correct_answer' => 'Từ đơn vị lớn đến đơn vị nhỏ (Năm -> Tháng -> Ngày)',
                'explanation' => 'Người Trung Quốc nói thời gian từ lớn đến nhỏ, khác với tiếng Việt. Ví dụ: Năm 2024 tháng 10 ngày 1 (2024年10月1号).',
                'difficulty' => 'starter',
                'skill_type' => 'grammar',
            ],
            [
                'question' => 'Ngày 25 tháng 8 nói tiếng Trung như thế nào?',
                'pinyin' => 'bā yuè èrshíwǔ hào',
                'options' => ['八月二十五号', '二十五号八月', '八号二十五月', '八月十五号'],
                'correct_answer' => '八月二十五号',
                'explanation' => 'Tháng trước ngày sau: 八月 (tháng 8) + 二十五号 (ngày 25).',
                'difficulty' => 'starter',
                'skill_type' => 'vocabulary',
            ],
            [
                'question' => 'Để hỏi hôm nay là thứ mấy, câu nào sau đây đúng?',
                'pinyin' => 'Jīntiān xīngqī jǐ?',
                'options' => ['今天星期几？', '今天几星期？', '今天几号？', '今天几月？'],
                'correct_answer' => '今天星期几？',
                'explanation' => '"星期几" dùng để hỏi thứ trong tuần. "几号" là hỏi ngày (mùng mấy), "几月" là hỏi tháng.',
                'difficulty' => 'starter',
                'skill_type' => 'grammar',
            ],
        ],
...
<div class="space-y-8">
    ...
    <div class="space-y-6">
        ...
        'questions' => [
            ...
            [
                'question' => 'Động từ "想" (xiǎng) trong tiếng Trung có ý nghĩa gì khi kết hợp với động từ khác?',
                'pinyin' => 'xiǎng',
                'options' => ['Muốn, dự định làm gì đó', 'Đang làm gì đó', 'Sẽ làm gì đó (chắc chắn)', 'Đã làm gì đó'],
                'correct_answer' => 'Muốn, dự định làm gì đó',
                'explanation' => '"想" + Động từ biểu thị mong muốn hoặc ý định chủ quan. Ví dụ: 我想喝茶 (Tôi muốn uống trà).',
                'difficulty' => 'starter',
                'skill_type' => 'grammar',
            ],
            [
                'question' => 'Câu "Buổi chiều tôi muốn đi cửa hàng mua cốc" nói tiếng Trung như thế nào?',
                'pinyin' => 'Xiàwǔ wǒ xiǎng qù shāngdiàn mǎi bēizi',
                'options' => ['下午我想去商店买杯子。', '我想下午买杯子去商店。', '去商店我想买杯子下午。', '买杯子下午去商店我想。'],
                'correct_answer' => '下午我想去商店买杯子。',
                'explanation' => 'Trật tự câu chuẩn: Trạng ngữ thời gian (下午) + Chủ ngữ (我) + Động từ nguyện vọng (想) + Động từ chính (去商店买杯子).',
                'difficulty' => 'starter',
                'skill_type' => 'grammar',
            ],
            [
                'question' => 'Lượng từ "个" (gè) dùng trong trường hợp nào?',
                'pinyin' => 'gè',
                'options' => ['Là lượng từ phổ biến nhất, dùng cho người hoặc nhiều loại đồ vật không có lượng từ chuyên dụng', 'Chỉ dùng cho sách vở', 'Chỉ dùng cho quần áo', 'Chỉ dùng cho xe cộ'],
                'correct_answer' => 'Là lượng từ phổ biến nhất, dùng cho người hoặc nhiều loại đồ vật không có lượng từ chuyên dụng',
                'explanation' => '"个" là lượng từ vạn năng. Dùng cho người (一个人), cái cốc (一个杯子), trường học (一个学校), v.v.',
                'difficulty' => 'starter',
                'skill_type' => 'vocabulary',
            ],
        ],
...
<div class="space-y-8">
    ...
    <div class="space-y-6">
        ...
        'questions' => [
            ...
            [
                'question' => 'Cấu trúc "在 + [Địa điểm] + [Động từ]" có ý nghĩa gì?',
                'pinyin' => 'zài ...',
                'options' => ['Làm hành động gì đó tại một địa điểm', 'Đang đi đến một địa điểm', 'Sống ở một địa điểm', 'Thích một địa điểm'],
                'correct_answer' => 'Làm hành động gì đó tại một địa điểm',
                'explanation' => 'Cấu trúc giới từ "在 + Nơi chốn" làm trạng ngữ chỉ địa điểm xảy ra hành động. Ví dụ: 在医院工作 (làm việc ở bệnh viện).',
                'difficulty' => 'starter',
                'skill_type' => 'grammar',
            ],
            [
                'question' => 'Để hỏi "Bạn làm việc ở đâu?", câu tiếng Trung đúng là:',
                'pinyin' => 'Nǐ zài nǎr gōngzuò?',
                'options' => ['你在哪儿工作？', '你工作哪儿？', '哪儿你工作？', '你在什么工作？'],
                'correct_answer' => '你在哪儿工作？',
                'explanation' => 'Từ để hỏi "ở đâu" là "在哪儿", và nó phải đứng trước động từ theo cấu trúc trạng ngữ chỉ địa điểm: 主语 + 在哪儿 + 动词.',
                'difficulty' => 'starter',
                'skill_type' => 'grammar',
            ],
            [
                'question' => 'Từ "医生" (yīshēng) có nghĩa là gì?',
                'pinyin' => 'yīshēng',
                'options' => ['Bác sĩ', 'Giáo viên', 'Học sinh', 'Nhân viên'],
                'correct_answer' => 'Bác sĩ',
                'explanation' => '"医生" là bác sĩ, thường làm việc tại "医院" (yīyuàn - bệnh viện).',
                'difficulty' => 'starter',
                'skill_type' => 'vocabulary',
            ],
        ],
...
<div class="space-y-8">
    ...
    <div class="space-y-6">
        ...
        'questions' => [
            ...
            [
                'question' => 'Động từ "能" (néng) dùng để làm gì trong câu "我能坐这儿吗?"',
                'pinyin' => 'néng',
                'options' => ['Hỏi sự cho phép, ý kiến của người khác (Có thể/Được không?)', 'Hỏi khả năng bẩm sinh', 'Hỏi về thời gian', 'Hỏi về số lượng'],
                'correct_answer' => 'Hỏi sự cho phép, ý kiến của người khác (Có thể/Được không?)',
                'explanation' => '"能" (có thể) dùng để biểu thị khả năng khách quan hoặc dùng trong câu hỏi để xin phép một cách lịch sự.',
                'difficulty' => 'starter',
                'skill_type' => 'grammar',
            ],
            [
                'question' => 'Câu "Bàn của anh ấy ở đâu?" dịch sang tiếng Trung là:',
                'pinyin' => 'Tā de zhuōzi zài nǎr?',
                'options' => ['他的桌子在哪儿？', '他桌子在哪儿？', '桌子他的在哪儿？', '他在哪儿桌子？'],
                'correct_answer' => '他的桌子在哪儿？',
                'explanation' => '"桌子" là cái bàn. Câu hỏi nơi chốn dùng "在哪儿" ở cuối: Chủ ngữ (他的桌子) + 在 + 哪儿?',
                'difficulty' => 'starter',
                'skill_type' => 'vocabulary',
            ],
            [
                'question' => 'Từ "前面" (qiánmiàn) nghĩa là gì?',
                'pinyin' => 'qiánmiàn',
                'options' => ['Phía trước', 'Phía sau', 'Bên trong', 'Bên ngoài'],
                'correct_answer' => 'Phía trước',
                'explanation' => 'Phương vị từ "前" là trước, "前面" là phía trước. Ngược lại là "后面" (phía sau).',
                'difficulty' => 'starter',
                'skill_type' => 'vocabulary',
            ],
        ],
...
<div class="space-y-8">
    ...
    <div class="space-y-6">
        ...
        'questions' => [
            ...
            [
                'question' => 'Đại từ nghi vấn "几" (jǐ) thường được dùng để hỏi số lượng nhỏ hơn bao nhiêu?',
                'pinyin' => 'jǐ',
                'options' => ['Nhỏ hơn 10', 'Nhỏ hơn 100', 'Nhỏ hơn 1000', 'Bất kỳ số nào'],
                'correct_answer' => 'Nhỏ hơn 10',
                'explanation' => '"几" thường dùng hỏi số lượng ít, ước lượng dưới 10. Ví dụ: 几点 (mấy giờ), 几个 (mấy cái).',
                'difficulty' => 'starter',
                'skill_type' => 'grammar',
            ],
            [
                'question' => 'Để nói "8 giờ 30 phút", cách nói nào sau đây ĐÚNG?',
                'pinyin' => 'bā diǎn sānshí fēn',
                'options' => ['八点半', '八点三十', 'Cả hai đáp án đều đúng', '八点三十分钟'],
                'correct_answer' => 'Cả hai đáp án đều đúng',
                'explanation' => 'Có 2 cách nói rưỡi: dùng số phút "三十分" (30 phút) hoặc dùng từ "半" (rưỡi).',
                'difficulty' => 'starter',
                'skill_type' => 'vocabulary',
            ],
            [
                'question' => 'Trạng ngữ chỉ thời gian thường đứng ở vị trí nào trong câu?',
                'pinyin' => 'shíjiān zhuàngyǔ',
                'options' => ['Đầu câu hoặc ngay sau Chủ ngữ, trước Động từ', 'Cuối câu', 'Sau Động từ', 'Giữa Động từ và Tân ngữ'],
                'correct_answer' => 'Đầu câu hoặc ngay sau Chủ ngữ, trước Động từ',
                'explanation' => 'Thời gian trong tiếng Trung luôn phải đứng trước hành động. Ví dụ: 我明天去北京 hoặc 明天我去北京.',
                'difficulty' => 'starter',
                'skill_type' => 'grammar',
            ],
        ],
...
<div class="space-y-8">
    ...
    <div class="space-y-6">
        ...
        'questions' => [
            ...
            [
                'question' => 'Đại từ "怎么样" (zěnmeyàng) dùng để hỏi gì?',
                'pinyin' => 'zěnmeyàng',
                'options' => ['Hỏi về tính chất, tình trạng, hoặc xin ý kiến (Thế nào? Như thế nào?)', 'Hỏi nguyên nhân (Tại sao?)', 'Hỏi số lượng (Bao nhiêu?)', 'Hỏi địa điểm (Ở đâu?)'],
                'correct_answer' => 'Hỏi về tính chất, tình trạng, hoặc xin ý kiến (Thế nào? Như thế nào?)',
                'explanation' => '"怎么样" thường đứng cuối câu để hỏi tính chất: 天气怎么样？(Thời tiết thế nào?).',
                'difficulty' => 'starter',
                'skill_type' => 'grammar',
            ],
            [
                'question' => 'Từ "太...了" (tài...le) biểu thị ý nghĩa gì?',
                'pinyin' => 'tài ... le',
                'options' => ['Mức độ cao (quá, lắm)', 'Mức độ thấp (hơi hơi)', 'Phủ định (không)', 'Sự việc đã xảy ra'],
                'correct_answer' => 'Mức độ cao (quá, lắm)',
                'explanation' => 'Cấu trúc "太 + Tính từ + 了" biểu thị mức độ cao hoặc than thở. Ví dụ: 太热了 (Nóng quá!), 太好了 (Tốt quá!).',
                'difficulty' => 'starter',
                'skill_type' => 'grammar',
            ],
            [
                'question' => 'Câu "Hôm nay trời không mưa" dịch sang tiếng Trung là:',
                'pinyin' => 'Jīntiān bù xiàyǔ',
                'options' => ['今天不下雨。', '今天没有雨。', '今天不雨。', '今天没下雨。'],
                'correct_answer' => '今天不下雨。',
                'explanation' => '"下雨" là động từ (trời mưa). Phủ định hành động trong hiện tại/tương lai ta dùng "不".',
                'difficulty' => 'starter',
                'skill_type' => 'vocabulary',
            ],
        ],
...
<div class="space-y-8">
    ...
    <div class="space-y-6">
        ...
        'questions' => [
            ...
            [
                'question' => 'Cấu trúc "在...呢" (zài...ne) dùng để diễn tả gì?',
                'pinyin' => 'zài ... ne',
                'options' => ['Hành động đang diễn ra tại một thời điểm (đang...)', 'Hành động đã hoàn thành', 'Hành động sắp xảy ra', 'Kinh nghiệm trong quá khứ'],
                'correct_answer' => 'Hành động đang diễn ra tại một thời điểm (đang...)',
                'explanation' => 'Đây là cấu trúc tiếp diễn cơ bản. 主语 + 在 + 动词 + 呢. (Chủ ngữ + đang + làm gì + đó).',
                'difficulty' => 'starter',
                'skill_type' => 'grammar',
            ],
            [
                'question' => 'Đại từ "喂" (wèi) thường được dùng trong tình huống nào?',
                'pinyin' => 'wèi',
                'options' => ['Nghe điện thoại (Alo)', 'Chào hỏi người lớn tuổi', 'Tạm biệt', 'Xin lỗi'],
                'correct_answer' => 'Nghe điện thoại (Alo)',
                'explanation' => '"喂" (wèi hoặc wéi) được dùng làm từ cảm thán để bắt đầu cuộc gọi điện thoại, tương đương với "Alo" trong tiếng Việt.',
                'difficulty' => 'starter',
                'skill_type' => 'vocabulary',
            ],
            [
                'question' => 'Câu "Anh ấy đang xem TV" dịch là:',
                'pinyin' => 'Tā zài kàn diànshì ne',
                'options' => ['他在看电视呢。', '他看电视了。', '他去看电视。', '他想看电视呢。'],
                'correct_answer' => '他在看电视呢。',
                'explanation' => 'Áp dụng cấu trúc tiếp diễn: 他 (Chủ ngữ) + 在 (đang) + 看电视 (xem TV) + 呢 (trợ từ).',
                'difficulty' => 'starter',
                'skill_type' => 'grammar',
            ],
        ],
...
<div class="space-y-8">
    ...
    <div class="space-y-6">
        ...
        'questions' => [
            ...
            [
                'question' => 'Trợ từ "了" (le) đứng ngay sau động từ biểu thị điều gì?',
                'pinyin' => 'le',
                'options' => ['Hành động đã hoàn thành (sự hoàn tất)', 'Hành động đang diễn ra', 'Hành động sắp xảy ra', 'Phủ định hành động'],
                'correct_answer' => 'Hành động đã hoàn thành (sự hoàn tất)',
                'explanation' => 'Động từ + "了" cho biết hành động đó đã diễn ra và kết thúc xong. Ví dụ: 买了一本书 (đã mua một cuốn sách).',
                'difficulty' => 'starter',
                'skill_type' => 'grammar',
            ],
            [
                'question' => 'Từ "东西" (dōngxi) có nghĩa là gì?',
                'pinyin' => 'dōngxi',
                'options' => ['Đồ đạc, vật dụng nói chung', 'Phương hướng Đông Tây', 'Đồ ăn', 'Quần áo'],
                'correct_answer' => 'Đồ đạc, vật dụng nói chung',
                'explanation' => '"东西" mang thanh nhẹ ở âm tiết 2, chỉ đồ vật nói chung. Ví dụ: 买东西 (mua sắm đồ đạc).',
                'difficulty' => 'starter',
                'skill_type' => 'vocabulary',
            ],
            [
                'question' => 'Lượng từ của "衣服" (yīfu - quần áo) là gì?',
                'pinyin' => 'jiàn',
                'options' => ['件 (jiàn)', '个 (gè)', '本 (běn)', '些 (xiē)'],
                'correct_answer' => '件 (jiàn)',
                'explanation' => 'Lượng từ dành cho áo, trang phục thân trên hoặc sự việc là "件". Ví dụ: 一件衣服 (một bộ quần áo).',
                'difficulty' => 'starter',
                'skill_type' => 'vocabulary',
            ],
        ],
...
<div class="space-y-8">
    ...
    <div class="space-y-6">
        ...
        'questions' => [
            ...
            [
                'question' => 'Cấu trúc "是...的" (shì...de) được dùng trong trường hợp nào?',
                'pinyin' => 'shì ... de',
                'options' => ['Nhấn mạnh thời gian, địa điểm, phương thức của một hành động ĐÃ XẢY RA', 'Miêu tả hành động đang tiếp diễn', 'Dự đoán tương lai', 'So sánh hai sự vật'],
                'correct_answer' => 'Nhấn mạnh thời gian, địa điểm, phương thức của một hành động ĐÃ XẢY RA',
                'explanation' => 'Cấu trúc "是...的" chỉ dùng khi sự việc đã xảy ra, người nói muốn làm rõ hoặc nhấn mạnh chi tiết (khi nào, ở đâu, bằng cách nào).',
                'difficulty' => 'starter',
                'skill_type' => 'grammar',
            ],
            [
                'question' => 'Câu "Tôi đến bằng máy bay" nói như thế nào?',
                'pinyin' => 'Wǒ shì zuò fēijī lái de',
                'options' => ['我是坐飞机来的。', '我坐飞机了来。', '我来坐飞机。', '我是来坐飞机的。'],
                'correct_answer' => '我是坐飞机来的。',
                'explanation' => 'Nhấn mạnh phương tiện đi lại (bằng máy bay), dùng "是...的": 我 + 是 + 坐飞机 (phương thức) + 来 (hành động) + 的.',
                'difficulty' => 'starter',
                'skill_type' => 'grammar',
            ],
            [
                'question' => 'Từ "怎么" (zěnme) trong cấu trúc "怎么 + Động từ" mang ý nghĩa gì?',
                'pinyin' => 'zěnme',
                'options' => ['Hỏi cách thức thực hiện hành động (Làm như thế nào?)', 'Hỏi nguyên nhân (Tại sao?)', 'Hỏi thời gian (Khi nào?)', 'Hỏi ý kiến'],
                'correct_answer' => 'Hỏi cách thức thực hiện hành động (Làm như thế nào?)',
                'explanation' => '"怎么" đi liền trước động từ để hỏi phương thức. Ví dụ: 怎么去 (đi bằng phương tiện gì), 怎么写 (viết thế nào).',
                'difficulty' => 'starter',
                'skill_type' => 'vocabulary',
            ],
        ],
